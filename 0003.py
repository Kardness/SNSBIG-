...
print('-'* 65)
print('G 마켓의 분야별 Best Seller 상품 정보')
print('='* 65)
print('')
print('')
print('')
...
while count < page_length:
    ...
    print('상품 이미지를 로드 중 입니다.'+str(count/page_length*100)+"%진행")
    time.sleep(1)
    
soup =  BeautifulSoup(driver.page_source, 'html.parser')

f = open(save_path + 'G마켓 베스트.txt', 'a', encoding='utf-8') #쓰기 모드
...
#--------------------- 원가만 있을 때 원가, 최저가, 할인율 예외처리 ------------------------------------------------
    ...
    print("-----------------------------------------------------------------------------------------------")
    print("순위: " + seller_rank_temp)
    print("이름: " + seller_name_temp)
    ...
    f.write("-----------------------------------------------------------------------------------------------")
    f.write("순위: "+ seller_rank_temp + "\n")
    f.write("이름: "+ seller_name_temp + "\n")
