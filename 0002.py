...
print("=" *80)
print("아마존의 분야별 Best Seller 상품 정보 추출하기")
print("=" *80)
...
sec = input('''
    ...
    1.위 분야에서 자료를 수집할 분야의 번호를 선택하세요: ''')

cnt = int(input('2.해당 분야에서 크롤링 할 건수를 입력하세요: '))

f_dir = input("3.파일을 저장할 폴더명을 입력하세요:")
print("\n")
...
if cnt > 30 :
      print("요청 건수가 많아서 시간이 걸립니다 잠시만 기다려 주십시요")
else :
...
path = "C:/Users/user/Desktop/test/chromedriver.exe"
...
if cnt < 51 :
    ...
    print("\n")
    print("요청하신 데이터의 수량이 많아 다음 페이지의 데이터를 추출 중이오니 잠시만 기다려 주십시오")
    print("\n")   
...
amazon_best_seller['순위']=ranking2
amazon_best_seller['소개']=pd.Series(title3)
amazon_best_seller['가격']=pd.Series(price2)
amazon_best_seller['상품평 갯수']=pd.Series(sat_count2)
amazon_best_seller['평점']=pd.Series(score2)
